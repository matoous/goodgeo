...
import (
	...
	"github.com/matoous/goodgeo/encoding/ewkbhex"
	"github.com/matoous/goodgeo/encoding/geojson"
)
...
func populateDB(db *sql.DB) error {
	...
	for _, waypoint := range []struct {
		...
		{"London", goodgeo.NewPoint(goodgeo.XY).MustSetCoords([]float64{0.1275, 51.50722}).SetSRID(4326)},
	} {
