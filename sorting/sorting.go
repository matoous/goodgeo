...
func NewFlatCoordSorting2D(layout goodgeo.Layout, coordData []float64) FlatCoord {
...
func NewFlatCoordSorting(layout goodgeo.Layout, coordData []float64, comparator IsLess) FlatCoord {
	return FlatCoord{
		isLess: comparator,
		coords: coordData,
		layout: layout,
