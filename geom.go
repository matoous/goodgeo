...
// LayoutMismatchError is returned when geometries with different layouts
// cannot be combined.
...
// StrideMismatchError is returned when the stride does not match the expected
// stride.
...
// UnsupportedLayoutError is returned when the requested layout is not
// supported.
...
// UnsupportedTypeError is returned when the requested type is not supported.
