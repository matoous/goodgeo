...
func TestWpt(t *testing.T) {
	for i, tc := range []struct {
	...
	}{
		{
			...
			layout: goodgeo.XY,
			g:      goodgeo.NewPoint(goodgeo.XY).MustSetCoords([]float64{-71.119277, 42.438878}),
		},
		{
			...
			layout: goodgeo.XYZ,
			g:      goodgeo.NewPoint(goodgeo.XYZ).MustSetCoords([]float64{-71.119277, 42.438878, 44.586548}),
		},
		{
			data: "<wpt lat=\"42.438878\" lon=\"-71.119277\">\n" +
			...
			layout: goodgeo.XYM,
			g:      goodgeo.NewPoint(goodgeo.XYM).MustSetCoords([]float64{-71.119277, 42.438878, 1006981528}),
		},
		{
			data: "<wpt lat=\"42.438878\" lon=\"-71.119277\">\n" +
				"\t<ele>44.586548</ele>\n" +
			...
			layout:        goodgeo.XYZM,
			g:             goodgeo.NewPoint(goodgeo.XYZM).MustSetCoords([]float64{-71.119277, 42.438878, 44.586548, 1006981528}),
			noTestMarshal: true,
			noTestNew:     true,
		},
		{
...
func TestRte(t *testing.T) {
	for i, tc := range []struct {
	...
	}{
		{
			...
			layout: goodgeo.XY,
			g: goodgeo.NewLineString(goodgeo.XY).MustSetCoords(
				[]goodgeo.Coord{
					{-71.107628, 42.43095},
					{-71.109236, 42.43124},
				},
		...
		},
		{
			...
			layout: goodgeo.XYZ,
			g: goodgeo.NewLineString(goodgeo.XYZ).MustSetCoords(
				[]goodgeo.Coord{
		...
		},
		{
			...
			layout: goodgeo.XYM,
			g: goodgeo.NewLineString(goodgeo.XYM).MustSetCoords(
				[]goodgeo.Coord{
		...
		},
		{
			...
			layout: goodgeo.XYZM,
			g: goodgeo.NewLineString(goodgeo.XYZM).MustSetCoords(
				[]goodgeo.Coord{
...
func TestTrk(t *testing.T) {
	for i, tc := range []struct {
	...
	}{
		{
			...
			layout: goodgeo.XYZM,
			g: goodgeo.NewMultiLineString(goodgeo.XYZM).MustSetCoords(
				[][]goodgeo.Coord{
					{
