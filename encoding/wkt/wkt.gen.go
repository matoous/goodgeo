...
wktdefault:
	...
	case 9:
		...
		{
			wktVAL.geom = goodgeo.NewPointFlat(wktlex.(*wktLex).curLayout(), wktDollar[2].coordList)
		}
	case 10:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
			wktVAL.geom = goodgeo.NewPointEmpty(wktlex.(*wktLex).curLayout())
		}
	case 11:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
	...
	case 18:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
			wktVAL.geom = goodgeo.NewLineStringFlat(wktlex.(*wktLex).curLayout(), wktDollar[2].coordList)
		}
	case 19:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
			wktVAL.geom = goodgeo.NewLineString(wktlex.(*wktLex).curLayout())
		}
	case 20:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
	...
	case 27:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
			wktVAL.geom = goodgeo.NewPolygonFlat(wktlex.(*wktLex).curLayout(), wktDollar[2].flatRepr.flatCoords, wktDollar[2].flatRepr.ends)
		}
	case 28:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
			wktVAL.geom = goodgeo.NewPolygon(wktlex.(*wktLex).curLayout())
		}
	case 29:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
	...
	case 36:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
			wktVAL.geom = goodgeo.NewMultiPointFlat(
				wktlex.(*wktLex).curLayout(), wktDollar[2].flatRepr.flatCoords, goodgeo.NewMultiPointFlatOptionWithEnds(wktDollar[2].flatRepr.ends),
			)
		}
	case 37:
		wktDollar = wktS[wktpt-2 : wktpt+1]
	...
	case 38:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
			wktVAL.geom = goodgeo.NewMultiPoint(wktlex.(*wktLex).curLayout())
		}
	case 39:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
	...
	case 44:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
			wktVAL.geom = goodgeo.NewMultiLineStringFlat(wktlex.(*wktLex).curLayout(), wktDollar[2].flatRepr.flatCoords, wktDollar[2].flatRepr.ends)
		}
	case 45:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
	...
	case 46:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
			wktVAL.geom = goodgeo.NewMultiLineString(wktlex.(*wktLex).curLayout())
		}
	case 47:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
	...
	case 52:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
			wktVAL.geom = goodgeo.NewMultiPolygonFlat(wktlex.(*wktLex).curLayout(), wktDollar[2].multiPolyFlatRepr.flatCoords, wktDollar[2].multiPolyFlatRepr.endss)
		}
	case 53:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
	...
	case 54:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
			wktVAL.geom = goodgeo.NewMultiPolygon(wktlex.(*wktLex).curLayout())
		}
	case 55:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
	...
	case 61:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
			wktVAL.geomCollect = goodgeo.NewGeometryCollection()
		}
	case 62:
		wktDollar = wktS[wktpt-2 : wktpt+1]
		{
	...
	case 65:
		wktDollar = wktS[wktpt-1 : wktpt+1]
		{
			wktVAL.geomList = []goodgeo.T{wktDollar[1].geom}
		}
	case 68:
		wktDollar = wktS[wktpt-1 : wktpt+1]
		{
