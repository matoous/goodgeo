...
import "github.com/matoous/goodgeo"
...
%union {
	...
	geomList          []goodgeo.T
	geomCollect       *goodgeo.GeometryCollection
}
...
point:
	...
	{
		$$ = goodgeo.NewPointFlat(wktlex.(*wktLex).curLayout(), $2)
	}
|	point_base_type empty_in_base_type
	{
		$$ = goodgeo.NewPointEmpty(wktlex.(*wktLex).curLayout())
	}
...
point_non_base_type:
	POINTM
	{
		ok := wktlex.(*wktLex).validateAndSetLayoutIfNoLayout(goodgeo.XYM)
		if !ok {
			return 1
		}
	}
|	POINTZ
	{
		ok := wktlex.(*wktLex).validateAndSetLayoutIfNoLayout(goodgeo.XYZ)
		if !ok {
			return 1
		}
	}
|	POINTZM
	{
		ok := wktlex.(*wktLex).validateAndSetLayoutIfNoLayout(goodgeo.XYZM)
		if !ok {
			return 1
		}
	}
...
linestring:
	...
	{
		$$ = goodgeo.NewLineStringFlat(wktlex.(*wktLex).curLayout(), $2)
	}
|	linestring_base_type empty_in_base_type
	{
		$$ = goodgeo.NewLineString(wktlex.(*wktLex).curLayout())
	}
...
polygon:
	...
	{
		$$ = goodgeo.NewPolygonFlat(wktlex.(*wktLex).curLayout(), $2.flatCoords, $2.ends)
	}
|	polygon_base_type empty_in_base_type
	{
		$$ = goodgeo.NewPolygon(wktlex.(*wktLex).curLayout())
	}
...
multipoint:
	...
	{
		$$ = goodgeo.NewMultiPointFlat(
			wktlex.(*wktLex).curLayout(), $2.flatCoords, goodgeo.NewMultiPointFlatOptionWithEnds($2.ends),
		)
	}
...
|	multipoint_base_type empty_in_base_type
	{
		$$ = goodgeo.NewMultiPoint(wktlex.(*wktLex).curLayout())
	}
...
multilinestring:
	...
	{
		$$ = goodgeo.NewMultiLineStringFlat(wktlex.(*wktLex).curLayout(), $2.flatCoords, $2.ends)
	}
...
|	multilinestring_base_type empty_in_base_type
	{
		$$ = goodgeo.NewMultiLineString(wktlex.(*wktLex).curLayout())
	}
...
multipolygon:
	...
	{
		$$ = goodgeo.NewMultiPolygonFlat(wktlex.(*wktLex).curLayout(), $2.flatCoords, $2.endss)
	}
...
|	multipolygon_base_type empty_in_base_type
	{
		$$ = goodgeo.NewMultiPolygon(wktlex.(*wktLex).curLayout())
	}
...
geometry_collection:
	...
	{
		newCollection := goodgeo.NewGeometryCollection()
...
geometry_collection_base_type:
	GEOMETRYCOLLECTION
	{
		ok := wktlex.(*wktLex).validateAndPushLayoutStackFrame(goodgeo.NoLayout)
		if !ok {
			return 1
		}
	}
...
geometry_collection_non_base_type:
	GEOMETRYCOLLECTIONM
	{
		ok := wktlex.(*wktLex).validateAndPushLayoutStackFrame(goodgeo.XYM)
		if !ok {
			return 1
		}
	}
|	GEOMETRYCOLLECTIONZ
	{
		ok := wktlex.(*wktLex).validateAndPushLayoutStackFrame(goodgeo.XYZ)
		if !ok {
			return 1
		}
	}
|	GEOMETRYCOLLECTIONZM
	{
		ok := wktlex.(*wktLex).validateAndPushLayoutStackFrame(goodgeo.XYZM)
		if !ok {
			return 1
		}
	}
